...
export interface UniswapV2PairContract
  extends Truffle.Contract<UniswapV2PairInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<UniswapV2PairInstance>;
}
...
export interface UniswapV2PairInstance extends Truffle.ContractInstance {
