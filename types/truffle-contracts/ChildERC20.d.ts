...
export interface ChildERC20Contract
  extends Truffle.Contract<ChildERC20Instance> {
  "new"(
    _owner: string,
    _token: string,
    _name: string,
...
export interface ChildERC20Instance extends Truffle.ContractInstance {
